...
const FALLBACK_OPENAI_MODELS: ModelDescriptor[] = [
    ...
    },
    {
        ...
        deprecated: true,
        deprecatedMessage: "Superseded by GPT-4o. Please update your configuration.",
    },
    // Keep older IDs mapped as legacy if needed
    {
        id: "gpt-4",
        provider: "OPENAI",
        label: "GPT-4 (Legacy)",
        ...
        deprecated: true,
        deprecatedMessage: "Legacy model. Please use GPT-4o.",
    },
];
